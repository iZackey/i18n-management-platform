module.exports = {
    ...
    rules: {
        ...
        'no-mixed-spaces-and-tabs': 0, //[2, false], //禁止混用tab和空格
        ...
        'no-unused-vars': 0, // [0, { 'vars': 'all', 'args': 'after-used' }], //不能有声明后未被使用的变量或参数
        ...
        'consistent-this': 0, //[2, 'that'], //this别名
        ...
        'yoda': [2, 'never'], //禁止尤达条件
        'vue/no-use-v-if-with-v-for': 0 // ['error', {'allowUsingIterationVar': false}] 禁止 v-if v-for混用
    },
    parserOptions: {
        parser: 'babel-eslint'
    }
